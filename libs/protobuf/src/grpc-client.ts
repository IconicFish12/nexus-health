...
export class GrpcClient {
  ...
  private getGrpcUrl(
    ...
    const port =
      this.config.get<number>(`${servicePrefix}_GRPC_PORT`) ||
      this.config.get<number>('GRPC_PORT') ||
      defaultPort;
  ...
  appointmentService(): ClientOptions {
    return this.buildClientOptions(
  ...
  inventoryService(): ClientOptions {
    return this.buildClientOptions(
      'nexus.inventory.v1',
  ...
  notificationService(): ClientOptions {
    return this.buildClientOptions(
